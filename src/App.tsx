      ...
      <header className="bg-white/90 backdrop-blur border-b border-slate-200/80 sticky top-0 z-40 shadow-sm">
        <div className="w-full px-3 lg:px-5 h-16 flex items-center justify-between gap-4">
          ...
          <div className="flex flex-col items-end gap-2">
            ...
            {/* 남은 횟수 — Word 다운로드 버튼 바로 아래 */}
            <span className={`px-3 py-1 rounded-full text-[13px] font-bold flex items-center gap-1.5 whitespace-nowrap ${limitReached ? 'bg-red-50 text-red-500 border border-red-100' : 'bg-teal-50 text-teal-600 border border-teal-100'}`}>
